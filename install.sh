...
if [[ "$run_setup" =~ ^[Yy]$ ]]; then
    ...
    echo ""
    echo "   4. Connect to Frontend Dashboard:"
    echo "      - Open your browser and go to: https://terminal.cloudtraderpro.in"
    echo "      - Select Server Type (Localhost or Cloud Server)."
    echo "      - Enter your Backend URL (http://localhost:8002 or your Cloudflare Tunnel HTTPS URL)."
    echo "      - Enter your Dashboard Password and log in."
    echo ""
